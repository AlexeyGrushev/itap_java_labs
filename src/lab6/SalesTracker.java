...
// Разработать программу для учета продаж в магазине. Программа должна позволять добавлять
// проданные товары в коллекцию, выводить список проданных товаров,
// а также считать общую сумму продаж и наиболее популярный товар.

// Вариант 10
// Использовать CopyOnWriteArrayList для хранения списка проданных товаров
// с возможностью одновременного чтения и записи.
